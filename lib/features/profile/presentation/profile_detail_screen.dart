...
/// Detailed User Profile Screen with personal info, skills, experience, and education (PROFILE-01, MOB-01-05)
class ProfileDetailScreen extends StatefulWidget {
  final IProfileRepository? profileRepository;

  const ProfileDetailScreen({super.key, this.profileRepository});
