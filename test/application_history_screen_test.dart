...
void main() {
  ...
  testWidgets('ApplicationHistoryScreen renders title, filter chips, and application cards (MOB-01-06)', (
    tester,
  ) async {
  ...
  testWidgets('Tapping an application card navigates to ApplicationDetailScreen', (
    tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
