...
void main() {
  ...
  testWidgets('ApplyJobScreen renders job info, contact info, and file upload zone (MOB-01-04)', (
    tester,
  ) async {
  ...
  testWidgets('ApplyJobScreen shows validation error if submitting without selecting CV', (
    tester,
  ) async {
  ...
  testWidgets('ApplyJobScreen picks CV, adds cover letter suggestion, and submits successfully', (
    tester,
  ) async {
    tester.view.physicalSize = const Size(800, 1600);
    tester.view.devicePixelRatio = 1.0;
    ...
    await tester.pump(const Duration(milliseconds: 700)); // Advance past mock network delay
