...
void main() {
  ...
  testWidgets('JobDetailScreen renders job info, metrics, and content correctly',
      (tester) async {
    ...
    expect(find.text('Senior Flutter Developer (Cross-Platform)'), findsOneWidget);
  ...
  testWidgets('JobDetailScreen shows recruiter CTA when logged in as recruiter',
      (tester) async {
    // Log in as recruiter
  ...
  testWidgets('JobDetailScreen shows error view when job is not found',
    ...
    expect(find.text('Không tìm thấy thông tin tin tuyển dụng này.'), findsOneWidget);
