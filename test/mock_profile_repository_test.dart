...
void main() {
  ...
  group('MockProfileRepository Tests', () {
    test('getMyProfile returns seeded candidate profile (PROFILE-01-05)', () async {
    ...
    test('updateProfile modifies personal information (PROFILE-01-01)', () async {
    ...
    test('addSkill and deleteSkill manipulate skills collection (PROFILE-01-02)', () async {
      ...
      expect(profile.skills.any((s) => s.name == 'Golang & Microservices'), true);
    ...
    test('addExperience and deleteExperience manipulate work experiences (PROFILE-01-03)', () async {
      ...
      var profile = await repository.getMyProfile();
      expect(profile.experiences.any((e) => e.company == 'Shopee Vietnam'), true);
    ...
    test('addEducation and deleteEducation manipulate education history (PROFILE-01-04)', () async {
      ...
      var profile = await repository.getMyProfile();
      expect(profile.educations.any((e) => e.institution == 'Đại học Quốc tế RMIT'), true);
